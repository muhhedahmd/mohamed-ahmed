...
class EcomHeaderMenu {
    ...
    constructor(options = {}) {
        ...
        this._boundHeaderSelector = null 
    ...
    bindEvents() {
        if(!this._boundHeaderSelector) {
            this._boundHeaderSelector  = this.handleHeaderClick.bind(this)
        }
        if(this.header){
            this.header.addEventListener('click', this._boundHeaderSelector);
        }
    }
    ...
    destroy() {
        if (this.header) {
            this.header.removeEventListener('click', this._boundHeaderSelector);
        }
        this.isInitialized = false;
    }
}
